    ...
    return (
        <div className="relative h-screen flex items-center justify-center overflow-hidden flex-col">
            ...
            <div className="relative z-10 flex flex-col items-center w-full px-6 max-w-4xl">
                ...
                <button className="mt-6 px-8 py-3 sm:px-10 sm:py-4 bg-blue-800 hover:bg-blue-900 transition-all duration-300 cursor-pointer rounded-full text-base sm:text-lg font-medium text-white flex items-center">
